...
class TcpVegasW : public TcpNewReno
{
public:
  /**
   ...
   */
  TcpVegasW (const TcpVegasW& sock);
  virtual ~TcpVegasW (void);
  ...
  virtual void CongestionAvoidanceReno (Ptr<TcpSocketState> tcb, uint32_t segmentsAcked);

  virtual void IncreaseWindowReno (Ptr<TcpSocketState> tcb, uint32_t segmentsAcked);
